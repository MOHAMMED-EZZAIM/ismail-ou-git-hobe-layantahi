...
export class PropAppartementComponent implements OnInit{


  public _ok:boolean=false;

  public  propUpdate!:PropAppartement;
  constructor(public _service :PropAppartementService,public  _appartementService:AppartementService,private router:Router) {
  }
